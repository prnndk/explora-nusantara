        ...
        <div class="w-full max-w-lg">
            ...
            <div class="flex flex-col space-y-4">
                ...
                <x-input.password :transparent=true label="Password" :required=true name="password"
                    placeholder="********" />
                <x-input.password :transparent=true label="Confirm Password" :required=true name="confirm_password"
                    placeholder="********" />
                <x-input.tel :transparent=true label="Phone Number" :required=true name="phone" />
                <div class="w-full max-w-lg">
                    <label for="" class="block text-sm text-white tracking-wide mb-2">Account
                        Type</label>
                    <div class="flex">
