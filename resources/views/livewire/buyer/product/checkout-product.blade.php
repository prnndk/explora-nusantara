<div>
                ...
                <div class="flex-1">
                    ...
                    <div class="mt-4 border border-gray-300 rounded-lg p-3">
                        <div class="m-4 p-4">
                            ...
                            <p class="text-gray-500 text-sm">Estimated arrival on {{ \Carbon\Carbon::now()->monthName }}
                                {{ \Carbon\Carbon::now()->addDay(5)->day . ' - ' . \Carbon\Carbon::now()->addDay(10)->day }}
                            </p>
            ...
            <div class="border-t border-gray-300 pt-4 mb-4">
                <div class="flex justify-between items-center font-semibold">
                    ...
                    <span class="text-gray-900"
                        x-text="new Intl.NumberFormat('id-ID', { style: 'currency', currency: 'IDR' }).format(Number(@this.totaled) + Number(@this.totalPrice))"></span>
                </div>
            </div>
    ...
    <x-modal name="change-address" :show="false" title="Change Address">
        <div class="p-3 flex flex-col gap-4">
            ...
            <div class="flex flex-col gap-2">
                <x-input.text label="Shipping Address" :required="true" name="shipping_address" :transparent="false"
