<div>
    <div x-data="{
        ...
        >
            ...
            <span class="ml-2">Mulai Percakapan</span>
            @if($this->unreadChatsCount > 0)
                <span
                    class="absolute -top-2 -right-2 flex items-center justify-center min-w-5 h-5 px-1.5 text-xs text-white bg-red-500 rounded-full z-10">
...
@push('scripts')
    <script>
        ...
        //if typing in text area set the latest message to read
        document.addEventListener('DOMContentLoaded', () => {
            const sendMessageInput = document.getElementById('send-message');
            if (sendMessageInput) {
                sendMessageInput.addEventListener('input', () => {
                    //check whether the latest message is not empty and was not read
