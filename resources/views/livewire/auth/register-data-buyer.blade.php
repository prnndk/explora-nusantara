                ...
                <div class="flex flex-col md:flex-row gap-8">
                    <div class="w-full md:w-1/2 space-y-4">
                        ...
                        <x-input.tel placeholder="08xxxxxxxxxx" label="Phone Number" required="true" name="phone_number"
                            transparent="true" wire:model="phone_number" />
                    ...
                    <div class="w-full md:w-1/2 space-y-4 ">
                        ...
                        <x-input.text label="Country" required="true" name="country" transparent="true"
                            wire:model="country" label="Country Name" placeholder="Indonesia" />
                        ...
                        <x-input.tel placeholder="08xxxxxxxxxx" label="Company Phone Number" required="true"
                            name="company_phone_number" transparent="true" wire:model="company_phone_number" />
                        <x-input.text placeholder="Your Bank" label="Bank" required="true" name="bank_name"
